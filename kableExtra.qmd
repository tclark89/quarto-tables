...
The `kable_styling` function can be used to further customize the table with ease.
  ...
  `basic`, `striped`, `bordered` and more. See `help(kable_styling)` for more
  information. I like to use `c("striped", "responsive", "hover")` as a starting
  point for HTML tables. 
